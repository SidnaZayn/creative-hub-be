...
describe('POST /api/space', () => {
    test('create space with valid data', async () => {
        ...
        const response = await request(global.app)
            ...
            .field('categoryId', '0b0269e4-2b78-4f14-8e18-624afb252e86')
        ...
        expect(response.body.data.space.categoryId).toBe('0b0269e4-2b78-4f14-8e18-624afb252e86');
    }, 10000);
});
    ...
    test('update space by id', async () => {
        const response = await request(global.app)
            ...
            .send({
                ...
                description: 'desc',
                city: 'Jakarta',
                features: JSON.stringify({ audio: true, wifi: true, projector: true, ac: true }),
                capacity: 11,
                pricePerHour: 51000,
            })
            .set('Authorization', 'Bearer ' + userToken);
